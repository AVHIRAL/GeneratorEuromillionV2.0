...
print ( "####################### AVHIRAL TE@M #######################" )
print ( "############################################################" )
print ( "################ GENERATOR EUROMILLION V2.0 ################" )
print ( "############################################################" )
print ( "################### CODE : DAVID PILATO ####################" )
print ( "############################################################" )
print ( "" )
print("\033[36m# Option calculs de simulation active et utilisé V2.0 #")
print ( "" )
...
# Simulate the ball mixing process with rotation
print("\033[94mGénération des boules et des étoiles avec calcul de simulation...")

for i in range(4):
    # Rotate the balls
    for ball in main_balls:
        rotation_speed = random.uniform(*ball_speed_range)
        for j in range(int(rotation_speed * ball_rotation_time)):
            time.sleep(ball_rotation_time)
        # print(f"boule {ball} tournant à {rotation_speed} tours/s")
        
    # Rotate the stars
    for star in lucky_stars:
        rotation_speed = random.uniform(*star_speed_range)
        for j in range(int(rotation_speed * star_rotation_time)):
            time.sleep(star_rotation_time)
        # print(f"étoile {star} tournant à {rotation_speed} tours/s")
    
    # Wait for the next set of balls and stars
    if i < 3:
        time.sleep(4)
